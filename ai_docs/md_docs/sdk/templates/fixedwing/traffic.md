...
You can *[change the file location](#graph_gen_on_init)* or *[use an existing `.json` file](#graph_reuse)* when *[configuring traffic simulation for your project](../../../sdk/templates/fixedwing/custom.md#custom_traffic)*.
