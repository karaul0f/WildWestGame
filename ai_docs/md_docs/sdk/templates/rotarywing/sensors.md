# Rotary-Wing Template - Sensors Simulation
...
![](../modules/sensors/img/igsensor_rotary.png)
...
- `hide_hud` - hides the *[HUD](../../../sdk/templates/rotarywing/avionics_hud.md#hud_disable)* for the camera it's assigned to;


![](../modules/sensors/img/tag_rotary.png)
...
The *[API](../../../sdk/templates/rotarywing/api.md)* provides direct access to sensor creation, binding, state control, and synchronization via the following classes:
