# Rotary-Wing Template - Avionics HUD Simulation
...
The template contains a framework for simulating an aircraft HUD (heads-up display) - a transparent display system that projects flight instrument data into the camera's view.
 ...
 ![](../modules/avionics_hud/img/hud_framework.png)
The HUD replicates the information displayed on the *[cockpit instruments](../../../sdk/templates/rotarywing/avionics_indicators.md)*.
