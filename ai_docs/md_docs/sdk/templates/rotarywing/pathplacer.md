# Rotary-Wing Template - PathPlacer Plugin
...
A *Dummy Node* with the two components assigned is automatically added to the scene when *[a new spline is created](../../../sdk/templates/rotarywing/custom.md#custom_path)*.
