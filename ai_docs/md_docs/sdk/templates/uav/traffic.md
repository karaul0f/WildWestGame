# UAV Template - Background Traffic Simulation
...
You can *[change the file location](#graph_gen_on_init)* or *[use an existing `.json` file](#graph_reuse)* when *[configuring traffic simulation for your project](../../../sdk/templates/uav/custom.md#custom_traffic)*.
...
2. If vehicle speed is too high, graph segmentation too coarse, and *[Vehicle Reach Target Distance](#reach_target_distance)* (*TrafficGraphController* component setting) too large, vehicles may overshoot sharp turns and begin circling around a single vertex. This can be resolved by:
