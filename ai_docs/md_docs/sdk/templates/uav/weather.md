# UAV Template - Weather Simulation
...
You can adjust the minimum, maximum, and default values for the *Weather Configurator* in the Editor via the `WidgetWeatherConfigurator` property assigned to the `weather` node in the *World Nodes* hierarchy:

 ![](../modules/weather/img/weather_prop.png)
