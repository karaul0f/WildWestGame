...
Only *PNG* and *JPEG* formats are supported for runtime loading into an *[Image](../../../api/library/common/class.image_cpp.md)* Class instance from raw data.
...
**SDK Path:***<SAMPLES_PROJECT_PATH>/data/csharp_component_samples/network/http_image_request*
## HTTP Request Handling

![](../../../samples/img/csharp_component_samples_http_request_handling.jpg)
...
**SDK Path:***<SAMPLES_PROJECT_PATH>/data/csharp_component_samples/network/http_request_handling*
## TCP Sockets
...
**SDK Path:***<SAMPLES_PROJECT_PATH>/data/csharp_component_samples/network/tcp_sockets*
## UDP Sockets
...
**SDK Path:***<SAMPLES_PROJECT_PATH>/data/csharp_component_samples/network/udp_sockets*
