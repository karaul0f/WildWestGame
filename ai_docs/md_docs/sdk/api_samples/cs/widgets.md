...
**SDK Path:***<SAMPLES_PROJECT_PATH>/data/csharp_component_samples/user_interface/object_frame*
## Object Text
...
**SDK Path:***<SAMPLES_PROJECT_PATH>/data/csharp_component_samples/user_interface/object_text*
## Target Marker
...
**SDK Path:***<SAMPLES_PROJECT_PATH>/data/csharp_component_samples/user_interface/target_marker*
...
**SDK Path:***<SAMPLES_PROJECT_PATH>/data/csharp_component_samples/user_interface/user_interface*
...
**SDK Path:***<SAMPLES_PROJECT_PATH>/data/csharp_component_samples/user_interface/widgets*
## Widget Canvas
...
**SDK Path:***<SAMPLES_PROJECT_PATH>/data/csharp_component_samples/user_interface/widget_canvas*
## Widget Containers
...
The *WidgetsContainers.cs* component shows how to use various layout and grouping widgets from the *[Gui](../../../api/library/gui/class.gui_cpp.md)* class to organize interface elements. It demonstrates vertical and horizontal box layouts, paned widgets, tabbed interfaces, group boxes, grid-based containers, and scrollable areas.
...
**SDK Path:***<SAMPLES_PROJECT_PATH>/data/csharp_component_samples/user_interface/widget_containers*
## Widget Dialog
...
**SDK Path:***<SAMPLES_PROJECT_PATH>/data/csharp_component_samples/user_interface/widget_dialog*
## Widget Manipulators
...
**SDK Path:***<SAMPLES_PROJECT_PATH>/data/csharp_component_samples/user_interface/widget_manipulators*
...
The window includes a *[WidgetEditLine](../../../api/library/gui/class.widgeteditline_cpp.md)* and a *[WidgetButton](../../../api/library/gui/class.widgetbutton_cpp.md)*. The *WidgetEditLine* listens for text changes via *[Widget.EventChanged](../../../api/library/gui/class.widget_cpp.md#getEventChanged_Event)* and logs the new input, while the WidgetButton uses *[Widget.EventClicked](../../../api/library/gui/class.widget_cpp.md#getEventClicked_Event)* to trigger an action when pressed. Font sizes are adjusted for better readability, and the layout is arranged automatically.


**SDK Path:***<SAMPLES_PROJECT_PATH>/data/csharp_component_samples/user_interface/widget_window*
