...
2. Select a template that meets your needs, and click **Create Project**. The project creation window will open. ![](../../sdk/projects/create_project_cpp.png) > **Notice:** You can also create a project by clicking *Create New* in the *My Projects* tab of the SDK browser, which automatically redirects you to the *Templates* tab. > > > ![](../../sdk/projects/projects.png)
...
See the **[video tutorial](../../videotutorials/how_to/how_to_cpp/create_project.md)** demonstrating how to create a new C++ project.
...
| VRPN Client plugin | Create a project with the *[VRPN Client](../../code/plugins/vrpn/index_cpp.md)* plugin. |
...
| Kinect2 Plugin | Create a project with the [Kinect2](../../code/plugins/kinect2/index_cpp.md) plugin. |
| Ultraleap | Tracking hands and fingers with *[Ultraleap](../../code/plugins/ultraleap/index_cpp.md)*. |
...
> **Notice:** The source code should be upgraded manually by using the *[Migration Guide](../../upgrade/migration_api_cpp.md)*.
...
| Microprofile Enabled | Run the application with the [Microprofile](../../tools/profiling/microprofile/index_cpp.md) tool enabled. |
...
- The *Development* build includes additional features that can be useful for project's development (*[Microprofile](../../tools/profiling/microprofile/index_cpp.md)*, etc.)
