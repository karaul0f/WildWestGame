...
| VRPN Client plugin | Create a project with the *[VRPN Client](../../code/plugins/vrpn/index_cs.md)* plugin. |
...
| Kinect2 Plugin | Create a project with the [Kinect2](../../code/plugins/kinect2/index_cs.md) plugin. |
| Ultraleap | Tracking hands and fingers with *[Ultraleap](../../code/plugins/ultraleap/index_cs.md)*. |
...
> **Notice:** The source code should be upgraded manually by using the *[Migration Guide](../../upgrade/migration_api_cs.md)*.
...
| Microprofile Enabled | Run the application with the [Microprofile](../../tools/profiling/microprofile/index_cs.md) tool enabled. |
...
- The *Development* build includes additional features that can be useful for project's development (*[Microprofile](../../tools/profiling/microprofile/index_cs.md)*, etc.)
