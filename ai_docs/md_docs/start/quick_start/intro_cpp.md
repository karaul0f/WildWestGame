# Quick Start with Component System (CPP)


Let's create a small game project to illustrate typical use cases and best practices for the [C++ Component System](../../principles/component_system/component_system_cpp/index.md).
...
[C++ Component System](../../principles/component_system/component_system_cpp/index.md) enables you to implement your application's logic via a set of building blocks � components, and assign these blocks to objects (*nodes*), giving them additional functionality. A logic component integrates a [node](../../start/index.md#node), a C++ class, containing logic implementation (actions to be performed), and a [property](../../principles/properties/index.md) defining a set of additional parameters to be used.


In this tutorial you will learn how to:


1. [Set Up the Project](../../start/quick_start/setup_project/index_cpp.md)
2. [Create the Controllable Character](../../start/quick_start/character/index_cpp.md)
3. [Implement Shooting](../../start/quick_start/shooting/index_cpp.md)
4. [Generate Physical Objects](../../start/quick_start/physical_objects/index_cpp.md)
5. [Implement Color Zone](../../start/quick_start/color_zone/index_cpp.md)
6. [Play Background Music](../../start/quick_start/music/index_cpp.md)
7. [Manage Game Rules](../../start/quick_start/game_rules/index_cpp.md)
8. [Create the End UI](../../start/quick_start/end_ui/index_cpp.md)
9. [Build the Project](../../start/quick_start/build/index_cpp.md)
...
We recommend you to use [Microsoft Visual Studio 2022](https://visualstudio.microsoft.com/):
...
UNIGINE automatically uses Visual Studio as the default IDE for editing the code of the C++ project. If it doesn't, you can set it [manually](../../videotutorials/how_to/how_to_basics/custom_ide.md) via the UNIGINE SDK.
...
You may also need to install a С++ compiler **GCC 8.3.0+**:
...
For more details refer to the [Programming Quick Reference](../../start/quick_start/pqr/index_cpp.md) article to learn key information on the workflow stages for developing a project with UNIGINE. It contains code examples that will be useful when developing your first UNIGINE projects.
