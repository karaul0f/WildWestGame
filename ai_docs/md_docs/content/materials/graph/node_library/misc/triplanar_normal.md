...
It's enough to simply pass the normal map texture to the node to get a working [triplanar projection](../../../../../content/materials/library/mesh_base/index.md#uv_base), all the other inputs have appropriate default values.
