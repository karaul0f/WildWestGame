...
![](../img/texture_buffer_screen_color.png)
...
This 2D Texture stores [screen color data](../../../../../principles/render/sequence/index.md#opaque_deferred) and can be used for post effects.
