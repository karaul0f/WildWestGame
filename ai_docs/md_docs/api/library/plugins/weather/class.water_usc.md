# Unigine::Plugins::Weather::Water Class (USC)
...
## void setBeaufortChangeType ( int type )

Sets a new type of transition between the current and target Beaufort wind force levels.
### Arguments

- *int* **type** - The type of transition between the current and target Beaufort wind force levels.

## int getBeaufortChangeType () const
...
Sets a new *[Water Global](../../../../api/library/objects/class.objectwaterglobal_usc.md)* object to be used.
...
- **node** - The *Water Global* object.

## getWaterNode () const

Returns the current *[Water Global](../../../../api/library/objects/class.objectwaterglobal_usc.md)* object to be used.
> **Notice:** The Water Global object is automatically found at the start of the project. Use this method only for dynamically created Water Global object.
...
Forced shoreline update (affects all *[FieldShoreline](../../../../api/library/fields/class.fieldshoreline_usc.md)* nodes).
