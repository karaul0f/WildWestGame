# Unigine::Plugins::Weather::Planet Class (CS)
...
The *Planet* interface is obtained via the *[Weather::Manager](../../../../api/library/plugins/weather/class.weather_manager_cs.md)* class.
