...
A class for the [VRPN Plugin](../../../../code/plugins/vrpn/index_cpp.md) that allows receiving data about position, orientation, velocity and acceleration of tracked objects from 3D tracking sensors.
