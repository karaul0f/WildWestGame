...
This class is used to create and modify a [field height](../../../objects/effects/fields/field_height/index.md). The field is applied to [global water](../../../api/library/objects/class.objectwaterglobal_usc.md) and specifies areas where height of waves should be changed.
...
- *string* **path** - The path to the heightmap texture.
...
- *int* **mode** - The blending mode, one of the [FIELD_HEIGHT_BLEND_*](#BLEND_ADDITIVE)values.
...
Current blending mode, one of the [FIELD_HEIGHT_BLEND_*](#BLEND_ADDITIVE)values.
...
- *vec3* **size** - The FieldHeight size. A [vec3](../../../api/library/math/class.vec3_usc.md) vector with components representing the sizes along the **X**, **Y** and **Z** axes, in units.
...
Current FieldHeight size. A [vec3](../../../api/library/math/class.vec3_usc.md) vector with components representing the sizes along the **X**, **Y** and **Z** axes, in units.
---
...
- *[Image](../../../api/library/common/class.image_usc.md)* **image** - Image instance with heightmap for FieldHeight.
...
Grabs the texture for the FieldHeight (already loaded to GPU) and saves it into the given [Image](../../../api/library/common/class.image_usc.md) instance.
### Arguments
...
[FieldHeight](../../../api/library/nodes/class.node_usc.md#FIELD_HEIGHT) type identifier.
