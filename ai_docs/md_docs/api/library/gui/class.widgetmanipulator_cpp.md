...
- *const  Math::[Mat4](../../../api/library/math/class.mat4_cpp.md)&* **modelview** - The model-view matrix of the handler
...
- *const  Math::[mat4](../../../api/library/math/class.mat4_cpp.md)&* **projection** - The projection matrix of the handler
...
- *const  Math::[Mat4](../../../api/library/math/class.mat4_cpp.md)&* **transform** - The transformation matrix of the handler
...
- *const  Math::[Mat4](../../../api/library/math/class.mat4_cpp.md)&* **basis** - The basis of the coordinate system for the handler
...
- *const  Math::[vec4](../../../api/library/math/class.vec4_cpp.md)&* **color** - The color for the manipulator
...
- *const [Ptr](../../../api/library/common/class.ptr_cpp.md)<[Gui](../../../api/library/gui/class.gui_cpp.md)>&* **gui** - The render GUI for the manipulator
