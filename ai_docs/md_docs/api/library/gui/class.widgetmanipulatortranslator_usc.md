# Unigine::WidgetManipulatorTranslator Class (USC)
...
## static WidgetManipulatorTranslator ( Gui gui )

Constructor. Creates a moving manipulator and adds it to the specified GUI.
### Arguments

- *[Gui](../../../api/library/gui/class.gui_usc.md)* **gui** - [GUI](../../../api/library/gui/class.gui_usc.md), to which the translator will belong.

## static WidgetManipulatorTranslator ( )
