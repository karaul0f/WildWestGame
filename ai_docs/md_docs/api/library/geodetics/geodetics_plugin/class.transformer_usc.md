...
## int engine.geodeticsTransformer. setProjectionWkt ( string projection_cs_wkt_string , dvec3 world_origin_geodetic_position , string geodetic_cs_string = WGS84 , bool geodetic_cs_is_well_known = true )
...
## int engine.geodeticsTransformer. setProjectionEpsg ( int projection_cs_epsg_code , dvec3 world_origin_geodetic_position , string geodetic_cs_string = WGS84 , bool geodetic_cs_is_well_known = true )
...
**1** on success; otherwise, **0**.
## dmat4 engine.geodeticsTransformer. geodeticToWorld ( dvec3 geodetic_position , bool rotate_to_en = false )
...
## dvec3 engine.geodeticsTransformer. geodeticToWorldPosition ( dvec3 geodetic_position , bool rotate_to_en = false )
