# Unigine::AnimationChannelVec2 Class (CPP)
...
This channel animates a two-component scalar vector over time. It is one row of a [sequence](../../../../api/library/animations/timeline/class.animationsequence_cpp.md), while everything the channels share, such as the animated parameter, the binding and the clips, comes from the [AnimationChannel](../../../../api/library/animations/timeline/class.animationchannel_cpp.md) base class.
...
## AnimationChannelVec2 ( AnimParams::PARAM param , const char * param_name )
...
## AnimationChannelVec2 ( const char * param )
...
## AnimationChannelVec2 ( const char * param , int param_index )
...
## AnimationChannelVec2 ( const char * param , const char * param_name )
...
## void assignFrom ( const Ptr < AnimationChannelVec2 > & channel )

Copies the content of the specified channel into this one.
### Arguments

- *const [Ptr](../../../../api/library/common/class.ptr_cpp.md)<[AnimationChannelVec2](../../../../api/library/animations/timeline/class.animationchannelvec2_cpp.md)> &* **channel** - Source channel to copy the content from.
