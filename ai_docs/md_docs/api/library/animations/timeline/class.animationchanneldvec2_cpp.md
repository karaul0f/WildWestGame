# Unigine::AnimationChannelDVec2 Class (CPP)
...
This channel animates a two-component double vector over time. It is one row of a [sequence](../../../../api/library/animations/timeline/class.animationsequence_cpp.md), while everything the channels share, such as the animated parameter, the binding and the clips, comes from the [AnimationChannel](../../../../api/library/animations/timeline/class.animationchannel_cpp.md) base class.
...
## AnimationChannelDVec2 ( AnimParams::PARAM param , const char * param_name )
...
## AnimationChannelDVec2 ( const char * param )
...
## AnimationChannelDVec2 ( const char * param , int param_index )
...
## AnimationChannelDVec2 ( const char * param , const char * param_name )
...
## void assignFrom ( const Ptr < AnimationChannelDVec2 > & channel )

Copies the content of the specified channel into this one.
### Arguments

- *const [Ptr](../../../../api/library/common/class.ptr_cpp.md)<[AnimationChannelDVec2](../../../../api/library/animations/timeline/class.animationchanneldvec2_cpp.md)> &* **channel** - Source channel to copy the content from.
...
- *const  Math::[dvec2](../../../../api/library/math/class.dvec2_cpp.md) &* **value** - Value to be held by the key.
