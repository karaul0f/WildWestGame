# Unigine::AnimationChannelVec2 Class (CS)

**Inherits from:** AnimationChannel


This channel animates a two-component scalar vector over time. It is one row of a [sequence](../../../../api/library/animations/timeline/class.animationsequence_cs.md), while everything the channels share, such as the animated parameter, the binding and the clips, comes from the [AnimationChannel](../../../../api/library/animations/timeline/class.animationchannel_cs.md) base class.


## AnimationChannelVec2 Class
...
## AnimationChannelVec2 ( AnimParams.PARAM param )
...
## AnimationChannelVec2 ( AnimParams.PARAM param , int param_index )
...
## AnimationChannelVec2 ( AnimParams.PARAM param , string param_name )
...
## AnimationChannelVec2 ( string param )
...
## AnimationChannelVec2 ( string param , int param_index )
...
## AnimationChannelVec2 ( string param , string param_name )
...
## void AssignFrom ( AnimationChannelVec2 channel )

Copies the content of the specified channel into this one.
### Arguments

- *[AnimationChannelVec2](../../../../api/library/animations/timeline/class.animationchannelvec2_cs.md)* **channel** - Source channel to copy the content from.
...
Value the channel holds at the specified moment.
## void AddValue ( float time , vec2 value , AnimationCurve.KEY_TYPE type = AnimationCurve::KEY_TYPE_LINEAR )

Adds a key holding the specified value.
### Arguments

- *float* **time** - Moment the key is to sit at, in seconds.
- *vec2* **value** - Value to be held by the key.
