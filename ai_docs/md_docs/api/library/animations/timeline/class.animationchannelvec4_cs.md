# Unigine::AnimationChannelVec4 Class (CS)

**Inherits from:** AnimationChannel


This channel animates a four-component scalar vector over time. It is one row of a [sequence](../../../../api/library/animations/timeline/class.animationsequence_cs.md), while everything the channels share, such as the animated parameter, the binding and the clips, comes from the [AnimationChannel](../../../../api/library/animations/timeline/class.animationchannel_cs.md) base class.
...
## AnimationChannelVec4 ( AnimParams.PARAM param , string param_name )
...
## AnimationChannelVec4 ( string param )
...
## AnimationChannelVec4 ( string param , int param_index )
...
## AnimationChannelVec4 ( string param , string param_name )
...
## void AssignFrom ( AnimationChannelVec4 channel )

Copies the content of the specified channel into this one.
### Arguments

- *[AnimationChannelVec4](../../../../api/library/animations/timeline/class.animationchannelvec4_cs.md)* **channel** - Source channel to copy the content from.
