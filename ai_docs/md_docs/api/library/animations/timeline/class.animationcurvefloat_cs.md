# Unigine::AnimationCurveFloat Class (CS)
...
## void AssignFrom ( AnimationCurveFloat curve )

Copies all data (key points and tangents) from the specified source curve.
### Arguments

- *[AnimationCurveFloat](../../../../api/library/animations/timeline/class.animationcurvefloat_cs.md)* **curve** - Source curve.
...
Index of the added key point.
## int AddKey ( float time , float value , AnimationCurve.KEY_TYPE type , vec2 left_tangent , vec2 right_tangent )
