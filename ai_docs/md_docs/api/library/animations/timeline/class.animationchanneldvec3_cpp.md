# Unigine::AnimationChannelDVec3 Class (CPP)
...
This channel animates a three-component double vector over time. It is one row of a [sequence](../../../../api/library/animations/timeline/class.animationsequence_cpp.md), while everything the channels share, such as the animated parameter, the binding and the clips, comes from the [AnimationChannel](../../../../api/library/animations/timeline/class.animationchannel_cpp.md) base class.


## AnimationChannelDVec3 Class
...
## AnimationChannelDVec3 ( AnimParams::PARAM param )
...
## AnimationChannelDVec3 ( AnimParams::PARAM param , int param_index )
...
## AnimationChannelDVec3 ( AnimParams::PARAM param , const char * param_name )
...
## AnimationChannelDVec3 ( const char * param )
...
## AnimationChannelDVec3 ( const char * param , int param_index )
...
## AnimationChannelDVec3 ( const char * param , const char * param_name )
...
## void assignFrom ( const Ptr < AnimationChannelDVec3 > & channel )

Copies the content of the specified channel into this one.
### Arguments

- *const [Ptr](../../../../api/library/common/class.ptr_cpp.md)<[AnimationChannelDVec3](../../../../api/library/animations/timeline/class.animationchanneldvec3_cpp.md)> &* **channel** - Source channel to copy the content from.
...
- *const  Math::[dvec3](../../../../api/library/math/class.dvec3_cpp.md) &* **value** - Value to be held by the key.
