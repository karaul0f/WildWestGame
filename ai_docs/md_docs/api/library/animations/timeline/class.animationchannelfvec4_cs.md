# Unigine::AnimationChannelFVec4 Class (CS)

**Inherits from:** AnimationChannel


This channel animates a four-component float vector over time. It is one row of a [sequence](../../../../api/library/animations/timeline/class.animationsequence_cs.md), while everything the channels share, such as the animated parameter, the binding and the clips, comes from the [AnimationChannel](../../../../api/library/animations/timeline/class.animationchannel_cs.md) base class.


## AnimationChannelFVec4 Class
...
## AnimationChannelFVec4 ( AnimParams.PARAM param )
...
## AnimationChannelFVec4 ( AnimParams.PARAM param , int param_index )
...
## AnimationChannelFVec4 ( AnimParams.PARAM param , string param_name )
...
## AnimationChannelFVec4 ( string param )
...
## AnimationChannelFVec4 ( string param , int param_index )
...
## AnimationChannelFVec4 ( string param , string param_name )
...
## void AssignFrom ( AnimationChannelFVec4 channel )

Copies the content of the specified channel into this one.
### Arguments

- *[AnimationChannelFVec4](../../../../api/library/animations/timeline/class.animationchannelfvec4_cs.md)* **channel** - Source channel to copy the content from.

## vec4 GetValueByTime ( float time )
...
## vec4 GetValueByNormalizedTime ( float normalized_time )
...
Value the channel holds at the specified moment.
## void AddValue ( float time , vec4 value , AnimationCurve.KEY_TYPE type = AnimationCurve::KEY_TYPE_LINEAR )

Adds a key holding the specified value.
### Arguments

- *float* **time** - Moment the key is to sit at, in seconds.
- *vec4* **value** - Value to be held by the key.
