# Unigine::AnimationChannelDVec4 Class (CS)

**Inherits from:** AnimationChannel


This channel animates a four-component double vector over time. It is one row of a [sequence](../../../../api/library/animations/timeline/class.animationsequence_cs.md), while everything the channels share, such as the animated parameter, the binding and the clips, comes from the [AnimationChannel](../../../../api/library/animations/timeline/class.animationchannel_cs.md) base class.
...
## AnimationChannelDVec4 ( AnimParams.PARAM param , string param_name )
...
## AnimationChannelDVec4 ( string param )
...
## AnimationChannelDVec4 ( string param , int param_index )
...
## AnimationChannelDVec4 ( string param , string param_name )
...
## void AssignFrom ( AnimationChannelDVec4 channel )

Copies the content of the specified channel into this one.
### Arguments

- *[AnimationChannelDVec4](../../../../api/library/animations/timeline/class.animationchanneldvec4_cs.md)* **channel** - Source channel to copy the content from.
...
Value the channel holds at the specified moment.
## void AddValue ( float time , dvec4 value , AnimationCurve.KEY_TYPE type = AnimationCurve::KEY_TYPE_LINEAR )

Adds a key holding the specified value.
### Arguments

- *float* **time** - Moment the key is to sit at, in seconds.
- *dvec4* **value** - Value to be held by the key.
