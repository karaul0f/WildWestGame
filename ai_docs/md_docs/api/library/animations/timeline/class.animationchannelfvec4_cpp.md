# Unigine::AnimationChannelFVec4 Class (CPP)
...
This channel animates a four-component float vector over time. It is one row of a [sequence](../../../../api/library/animations/timeline/class.animationsequence_cpp.md), while everything the channels share, such as the animated parameter, the binding and the clips, comes from the [AnimationChannel](../../../../api/library/animations/timeline/class.animationchannel_cpp.md) base class.
...
- *const [Ptr](../../../../api/library/common/class.ptr_cpp.md)<[AnimationCurveFloat](../../../../api/library/animations/timeline/class.animationcurvefloat_cpp.md)>&* **w** - The curve of the W component
...
## AnimationChannelFVec4 ( AnimParams::PARAM param , const char * param_name )
...
## AnimationChannelFVec4 ( const char * param )
...
## AnimationChannelFVec4 ( const char * param , int param_index )
...
## AnimationChannelFVec4 ( const char * param , const char * param_name )
...
## void assignFrom ( const Ptr < AnimationChannelFVec4 > & channel )

Copies the content of the specified channel into this one.
### Arguments

- *const [Ptr](../../../../api/library/common/class.ptr_cpp.md)<[AnimationChannelFVec4](../../../../api/library/animations/timeline/class.animationchannelfvec4_cpp.md)> &* **channel** - Source channel to copy the content from.
