# Unigine::AnimationChannelFVec3 Class (CS)

**Inherits from:** AnimationChannel


This channel animates a three-component float vector over time. It is one row of a [sequence](../../../../api/library/animations/timeline/class.animationsequence_cs.md), while everything the channels share, such as the animated parameter, the binding and the clips, comes from the [AnimationChannel](../../../../api/library/animations/timeline/class.animationchannel_cs.md) base class.
...
## AnimationChannelFVec3 ( AnimParams.PARAM param , string param_name )
...
## AnimationChannelFVec3 ( string param )
...
## AnimationChannelFVec3 ( string param , int param_index )
...
## AnimationChannelFVec3 ( string param , string param_name )
...
## void AssignFrom ( AnimationChannelFVec3 channel )

Copies the content of the specified channel into this one.
### Arguments

- *[AnimationChannelFVec3](../../../../api/library/animations/timeline/class.animationchannelfvec3_cs.md)* **channel** - Source channel to copy the content from.
