# Unigine::AnimationChannelInt Class (CPP)
...
This channel animates an integer parameter over time. It is one row of a [sequence](../../../../api/library/animations/timeline/class.animationsequence_cpp.md), while everything the channels share, such as the animated parameter, the binding and the clips, comes from the [AnimationChannel](../../../../api/library/animations/timeline/class.animationchannel_cpp.md) base class.


## AnimationChannelInt Class
...
## AnimationChannelInt ( AnimParams::PARAM param )
...
## AnimationChannelInt ( AnimParams::PARAM param , int param_index )
...
## AnimationChannelInt ( AnimParams::PARAM param , const char * param_name )
...
## AnimationChannelInt ( const char * param )
...
## AnimationChannelInt ( const char * param , int param_index )
...
## AnimationChannelInt ( const char * param , const char * param_name )
...
## void assignFrom ( const Ptr < AnimationChannelInt > & channel )

Copies the content of the specified channel into this one.
### Arguments

- *const [Ptr](../../../../api/library/common/class.ptr_cpp.md)<[AnimationChannelInt](../../../../api/library/animations/timeline/class.animationchannelint_cpp.md)> &* **channel** - Source channel to copy the content from.
...
- *int* **value** - Value to be held by the key.
