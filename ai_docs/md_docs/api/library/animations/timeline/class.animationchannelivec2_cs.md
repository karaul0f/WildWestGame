# Unigine::AnimationChannelIVec2 Class (CS)

**Inherits from:** AnimationChannel


This channel animates a two-component integer vector over time. It is one row of a [sequence](../../../../api/library/animations/timeline/class.animationsequence_cs.md), while everything the channels share, such as the animated parameter, the binding and the clips, comes from the [AnimationChannel](../../../../api/library/animations/timeline/class.animationchannel_cs.md) base class.
...
## AnimationChannelIVec2 ( AnimParams.PARAM param , string param_name )
...
## AnimationChannelIVec2 ( string param )
...
## AnimationChannelIVec2 ( string param , int param_index )
...
## AnimationChannelIVec2 ( string param , string param_name )
...
## void AssignFrom ( AnimationChannelIVec2 channel )

Copies the content of the specified channel into this one.
### Arguments

- *[AnimationChannelIVec2](../../../../api/library/animations/timeline/class.animationchannelivec2_cs.md)* **channel** - Source channel to copy the content from.
...
Value the channel holds at the specified moment.
## void AddValue ( float time , ivec2 value , AnimationCurve.KEY_TYPE type = AnimationCurve::KEY_TYPE_LINEAR )

Adds a key holding the specified value.
### Arguments

- *float* **time** - Moment the key is to sit at, in seconds.
- *ivec2* **value** - Value to be held by the key.
