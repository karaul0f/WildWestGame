# Unigine::AnimationChannelFVec3 Class (CPP)
...
This channel animates a three-component float vector over time. It is one row of a [sequence](../../../../api/library/animations/timeline/class.animationsequence_cpp.md), while everything the channels share, such as the animated parameter, the binding and the clips, comes from the [AnimationChannel](../../../../api/library/animations/timeline/class.animationchannel_cpp.md) base class.


## AnimationChannelFVec3 Class
...
## AnimationChannelFVec3 ( AnimParams::PARAM param )
...
## AnimationChannelFVec3 ( AnimParams::PARAM param , int param_index )
...
## AnimationChannelFVec3 ( AnimParams::PARAM param , const char * param_name )
...
## AnimationChannelFVec3 ( const char * param )
...
## AnimationChannelFVec3 ( const char * param , int param_index )
...
## AnimationChannelFVec3 ( const char * param , const char * param_name )
...
## void assignFrom ( const Ptr < AnimationChannelFVec3 > & channel )

Copies the content of the specified channel into this one.
### Arguments

- *const [Ptr](../../../../api/library/common/class.ptr_cpp.md)<[AnimationChannelFVec3](../../../../api/library/animations/timeline/class.animationchannelfvec3_cpp.md)> &* **channel** - Source channel to copy the content from.
