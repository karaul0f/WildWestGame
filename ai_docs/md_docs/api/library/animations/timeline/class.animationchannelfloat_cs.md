# Unigine::AnimationChannelFloat Class (CS)

**Inherits from:** AnimationChannel


This channel animates a float parameter over time. It is one row of a [sequence](../../../../api/library/animations/timeline/class.animationsequence_cs.md), while everything the channels share, such as the animated parameter, the binding and the clips, comes from the [AnimationChannel](../../../../api/library/animations/timeline/class.animationchannel_cs.md) base class.
...
## AnimationChannelFloat ( AnimParams.PARAM param , string param_name )
...
## AnimationChannelFloat ( string param )
...
## AnimationChannelFloat ( string param , int param_index )
...
## AnimationChannelFloat ( string param , string param_name )
...
## void AssignFrom ( AnimationChannelFloat channel )

Copies the content of the specified channel into this one.
### Arguments

- *[AnimationChannelFloat](../../../../api/library/animations/timeline/class.animationchannelfloat_cs.md)* **channel** - Source channel to copy the content from.
