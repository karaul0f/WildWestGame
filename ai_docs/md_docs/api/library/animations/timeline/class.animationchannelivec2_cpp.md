# Unigine::AnimationChannelIVec2 Class (CPP)
...
This channel animates a two-component integer vector over time. It is one row of a [sequence](../../../../api/library/animations/timeline/class.animationsequence_cpp.md), while everything the channels share, such as the animated parameter, the binding and the clips, comes from the [AnimationChannel](../../../../api/library/animations/timeline/class.animationchannel_cpp.md) base class.


## AnimationChannelIVec2 Class
...
## AnimationChannelIVec2 ( AnimParams::PARAM param )
...
## AnimationChannelIVec2 ( AnimParams::PARAM param , int param_index )
...
## AnimationChannelIVec2 ( AnimParams::PARAM param , const char * param_name )
...
## AnimationChannelIVec2 ( const char * param )
...
## AnimationChannelIVec2 ( const char * param , int param_index )
...
## AnimationChannelIVec2 ( const char * param , const char * param_name )
...
## void assignFrom ( const Ptr < AnimationChannelIVec2 > & channel )

Copies the content of the specified channel into this one.
### Arguments

- *const [Ptr](../../../../api/library/common/class.ptr_cpp.md)<[AnimationChannelIVec2](../../../../api/library/animations/timeline/class.animationchannelivec2_cpp.md)> &* **channel** - Source channel to copy the content from.
...
- *const  Math::[ivec2](../../../../api/library/math/class.ivec2_cpp.md) &* **value** - Value to be held by the key.
