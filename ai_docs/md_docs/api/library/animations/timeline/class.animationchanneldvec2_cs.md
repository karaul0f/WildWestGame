# Unigine::AnimationChannelDVec2 Class (CS)

**Inherits from:** AnimationChannel


This channel animates a two-component double vector over time. It is one row of a [sequence](../../../../api/library/animations/timeline/class.animationsequence_cs.md), while everything the channels share, such as the animated parameter, the binding and the clips, comes from the [AnimationChannel](../../../../api/library/animations/timeline/class.animationchannel_cs.md) base class.


## AnimationChannelDVec2 Class

### Properties

## 🔒︎ dvec2 DefaultValue
...
## AnimationChannelDVec2 ( AnimParams.PARAM param )
...
## AnimationChannelDVec2 ( AnimParams.PARAM param , int param_index )
...
## AnimationChannelDVec2 ( AnimParams.PARAM param , string param_name )
...
## AnimationChannelDVec2 ( string param )
...
## AnimationChannelDVec2 ( string param , int param_index )
...
## AnimationChannelDVec2 ( string param , string param_name )
...
## void AssignFrom ( AnimationChannelDVec2 channel )

Copies the content of the specified channel into this one.
### Arguments

- *[AnimationChannelDVec2](../../../../api/library/animations/timeline/class.animationchanneldvec2_cs.md)* **channel** - Source channel to copy the content from.

## dvec2 GetValueByTime ( float time )
...
## dvec2 GetValueByNormalizedTime ( float normalized_time )
...
Value the channel holds at the specified moment.
## void AddValue ( float time , dvec2 value , AnimationCurve.KEY_TYPE type = AnimationCurve::KEY_TYPE_LINEAR )

Adds a key holding the specified value.
### Arguments

- *float* **time** - Moment the key is to sit at, in seconds.
- *dvec2* **value** - Value to be held by the key.
