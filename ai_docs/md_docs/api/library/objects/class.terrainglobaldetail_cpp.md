...
- *const  Math::[vec4](../../../api/library/math/class.vec4_cpp.md)&* **color** - The albedo color multiplier for the detail
...
- *const char ** **name** - The path to the height texture of the detail
...
- *const char ** **name** - The path to the normal texture of the detail
...
- *const char ** **name** - The path to the roughness texture of the detail
...
- *const char ** **name** - The path to the albedo texture of the detail
...
- *bool* **triplanar** - value indicating if triplanar texture mapping is enabled for the detail
...
value indicating if triplanar texture mapping is enabled for the detail
## void setDetail ( bool detail )

Sets a new value indicating if the detail uses the mask of the parent detail.
### Arguments

- *bool* **detail** - value indicating if the detail uses the mask of the parent detail
...
value indicating if the detail uses the mask of the parent detail
## void setOverlap ( bool overlap )

Sets a new value indicating if overlap mode is enabled for the detail.
### Arguments

- *bool* **overlap** - value indicating if overlap mode is enabled for the detail
...
value indicating if overlap mode is enabled for the detail
...
Sets a new transformation parameters of the detail (a [Vec4](../../../api/library/math/class.vec4_cpp.md) value with the following components):
...
- *const  Math::[vec4](../../../api/library/math/class.vec4_cpp.md)&* **transform** - The transformation parameters of the detail

## Math:: vec4 getTransform () const

Returns the current transformation parameters of the detail (a [Vec4](../../../api/library/math/class.vec4_cpp.md) value with the following components):
- X - **Tile size X** - texture tile size along the X axis, in units.
- Y - **Tile size Y** - texture tile size along the Y axis, in units.
- Z - **Offset X** - texture offset along the X axis.
- W - **Offset Y** - texture offset along the Y axis.
...
- *const  Math::[vec4](../../../api/library/math/class.vec4_cpp.md)&* **color** - The color of the detail mask
...
- *bool* **enabled** - value indicating if the detail is enabled
...
value indicating if the detail is enabled
