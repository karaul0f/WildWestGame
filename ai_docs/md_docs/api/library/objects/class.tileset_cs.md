...
Image type identifier. See the [FORMAT_*](../../../api/library/common/class.image_cs.md#FORMAT_ATI1) variables.
...
- *[Image](../../../api/library/common/class.image_cs.md)* **data** - Source image containing a new tile data to be set.
...
- *ivec2* **tile_coord** - Tile coordinates in the tileset (X, Y).
- *[Image](../../../api/library/common/class.image_cs.md)* **data** - Image to which the tile data is to be copied.
...
Reloads the data for the tile with specified coordinates from the [tileset file](../../../api/library/objects/class.tilesetfile_cs.md).
### Arguments
...
1 if the tile data was successfully loaded from the [tileset file](../../../api/library/objects/class.tilesetfile_cs.md); otherwise, 0.
...
Saves changes of the specified tile to the [tileset file](../../../api/library/objects/class.tilesetfile_cs.md).
### Arguments
...
1 if changes of the specified tile were successfully saved to the [tileset file](../../../api/library/objects/class.tilesetfile_cs.md); otherwise, 0.
## int SaveAll ( int force = 1 )

Saves changes of all tiles to the [tileset file](../../../api/library/objects/class.tilesetfile_cs.md).
### Arguments
...
1 if all changes were successfully saved to the [tileset file](../../../api/library/objects/class.tilesetfile_cs.md); otherwise, 0.
...
Tile data image format. One of the [Image.FORMAT_*](../../../api/library/common/class.image_cs.md#FORMAT_ATI1) values.
## int GetMaskFormat ( )

Returns a value indicating current image format for the tile mask.
### Return value

Tile mask image format. One of the [Image.FORMAT_*](../../../api/library/common/class.image_cs.md#FORMAT_ATI1) values.
## string GetPath ( )

Returns the path to the [tileset file](../../../api/library/objects/class.tilesetfile_cs.md).
### Return value

Path to the [tileset file](../../../api/library/objects/class.tilesetfile_cs.md).
...
- *ivec2* **tile_coord** - Tile coordinates in the tileset (X, Y).
- *[Image](../../../api/library/common/class.image_cs.md)* **mask** - Image to which the tile mask is to be copied.
- *int* **force** - Force flag. > **Notice:** It is recommended to set this flag to 0 when possible to avoid spikes.
...
> **Notice:** This method does not remove the mask from the [tileset file](../../../api/library/objects/class.tilesetfile_cs.md).
...
- *ivec2* **tile_coord** - Tile coordinates in the tileset (X, Y).
- *[Image](../../../api/library/common/class.image_cs.md)* **mask** - Source image containing a new tile mask to be set.
...
Reloads the mask for the tile with specified coordinates from the [tileset file](../../../api/library/objects/class.tilesetfile_cs.md).
### Arguments
...
1 if the tile mask was successfully loaded from the [tileset file](../../../api/library/objects/class.tilesetfile_cs.md); otherwise, 0.
...
Returns a value indicating if the tile with specified coordinates has a mask in the [tileset file](../../../api/library/objects/class.tilesetfile_cs.md).
### Arguments
...
1 if the specified tile has a mask in the [tileset file](../../../api/library/objects/class.tilesetfile_cs.md); otherwise, 0.
...
Returns a value indicating if there is a tile with specified coordinates in the [tileset file](../../../api/library/objects/class.tilesetfile_cs.md).
### Arguments
...
1 if there is a tile with specified coordinates in the [tileset file](../../../api/library/objects/class.tilesetfile_cs.md); otherwise, 0.
## int RemoveTile ( ivec2 tile_coord )

Removes the tile with specified coordinates from the tileset.
> **Notice:** This method does not remove the tile from the [tileset file](../../../api/library/objects/class.tilesetfile_cs.md).
