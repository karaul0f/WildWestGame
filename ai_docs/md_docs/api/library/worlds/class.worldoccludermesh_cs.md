# Unigine.WorldOccluderMesh Class (CS)
...
The distance between the camera and the bounding box of the *Occluder Mesh*, at which this *Occluder Mesh* becomes disabled (it isn't processed by the cpu, hence it isn't rendered). by default, the inf value is used.
### Members
...
- *[Mesh](../../../api/library/rendering/class.mesh_cs.md)* **mesh** - A mesh to be copied.
...
- *[Mesh](../../../api/library/rendering/class.mesh_cs.md)* **mesh** - Target mesh.

### Return value

true if the mesh is copied successfully; otherwise, false.
## bool SetMeshPath ( string name , bool force_load = false )
