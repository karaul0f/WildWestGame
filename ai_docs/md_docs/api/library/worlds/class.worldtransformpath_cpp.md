...
Returns the current instance of the [*Path*](../../../api/library/common/class.path_cpp.md) class.path, by which the transformation is defined. by using this function, you can edit the current path or change velocity or transformation of the object moving along the path.
### Return value
