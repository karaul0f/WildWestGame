# Unigine::InputEventTextEditing Class (USC)
...
- *string* **text** - The IME composition (preedit) text
...
## InputEventTextEditing ( long timestamp , ivec2 mouse_pos )
...
## InputEventTextEditing ( long timestamp , ivec2 mouse_pos , string text , int cursor , int length )
