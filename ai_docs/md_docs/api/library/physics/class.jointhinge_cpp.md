...
The following code illustrates connection of two [bodies](../../../api/library/physics/class.body_cpp.md) (b0 and b1) using a hinge joint.
...
> **Notice:** The valid velocity is returned only if both bodies are of [BodyRigid](../../../api/library/physics/class.bodyrigid_cpp.md) type. Otherwise, **0** is returned.
