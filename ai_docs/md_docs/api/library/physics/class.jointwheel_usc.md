...
The following code illustrates connection of two [rigid bodies](../../../api/library/physics/class.bodyrigid_usc.md) (frame and wheel) using a wheel joint.
...
- Usage example: [Creating a Car with Wheel Joints](../../../code/usage/car_wheel_joints/index_usc.md)
