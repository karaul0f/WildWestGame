...
This class contains functions that enable to get or change parameters of a navigation area within which pathfinding is performed. The navigation area can be either a [navigation sector](../../../api/library/pathfinding/class.navigationsector_cpp.md) or a [navigation mesh](../../../api/library/pathfinding/class.navigationmesh_cpp.md).
...
Sets a new navigation mask of the navigation area. the navigation mask of the navigation area must [match](../../../principles/bit_masking/index.md) the [navigation mask](../../../api/library/pathfinding/class.pathroute_cpp.md#setNavigationMask_int_void) of the route that is calculated within it. Otherwise, the area will not participate in pathfinding.
### Arguments
...
Returns the current navigation mask of the navigation area. the navigation mask of the navigation area must [match](../../../principles/bit_masking/index.md) the [navigation mask](../../../api/library/pathfinding/class.pathroute_cpp.md#setNavigationMask_int_void) of the route that is calculated within it. Otherwise, the area will not participate in pathfinding.
### Return value
...
> **Notice:** If the danger factor exceeds the [maximum danger factor](../../../api/library/pathfinding/class.pathroute_cpp.md#setMaxDangerous_float_void) set for the route, the navigation area will be excluded from pathfinding calculations.
...
- *const [Ptr](../../../api/library/common/class.ptr_cpp.md)<[Navigation](../../../api/library/pathfinding/class.navigation_cpp.md)> &* **navigation** - Navigation area
