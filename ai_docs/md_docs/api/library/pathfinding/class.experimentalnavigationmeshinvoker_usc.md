# Unigine::ExperimentalNavigationMeshInvoker Class (USC)
...
## static ExperimentalNavigationMeshInvoker ( )
...
## int prefetchTilesForce ( WorldBoundBox bounds )
...
- *WorldBoundBox* **bounds** - Region whose tiles are needed, in world coordinates.
