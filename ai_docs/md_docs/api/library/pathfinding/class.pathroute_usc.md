...
- In case of **3D** route (available only for [navigation sectors](../../../api/library/pathfinding/class.navigationsector_usc.md)), a point moves in 3 dimensions. The radius set for the point via *[*setRadius()*](#setRadius_float_void)* is used to check whether the navigation sector can take part in pathfinding: if the radius set for the point is greater than the size of the navigation sector, it will be discarded. Also the point cannot rise up higher than the [maximum height](#setMaxHeight_float_void) set for the navigation sector.
...
Sets a new cosine of the maximum possible angle between [navigation mesh](../../../api/library/pathfinding/class.navigationmesh_usc.md) polygons. For example, this option enables to exclude walls when calculating a valid route.
### Arguments
...
Returns the current cosine of the maximum possible angle between [navigation mesh](../../../api/library/pathfinding/class.navigationmesh_usc.md) polygons. For example, this option enables to exclude walls when calculating a valid route.
### Return value
...
- *[PathRouteIntersection](../../../api/library/pathfinding/class.pathrouteintersection_usc.md)* **intersection** - PathRouteIntersection node.
...
- *[Node](../../../api/library/nodes/class.node_usc.md)* **navigation** - A navigation area to be ignored.
...
- *[Node](../../../api/library/nodes/class.node_usc.md)* **obstacle** - An obstacle to be ignored.
...
- *[Node](../../../api/library/nodes/class.node_usc.md)* **navigation** - A navigation area.
...
- *[Node](../../../api/library/nodes/class.node_usc.md)* **obstacle** - An obstacle.
