...
You'll see quite a few classes in there -don't worry, [this overview](../../../vr_development/vr_template/vr_template_classes_and_components/index_cpp.md) explains what each one does.


Before compiling, make sure you've set the right platform and configuration in *Visual Studio*.


![](ide_project_settings.png)


Now let's build and run for the first time.


Build your application in *Visual Studio* (*Build -> Build Solution*) and launch it by selecting the project on the *My Projects* tab and clicking **Run**.


Before running, make sure the right *Customize Run Options* (*Debug* in our case) are selected -click the ellipsis under the **Run** button to check.
