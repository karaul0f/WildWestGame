...
3. Create tangents and normals by using the *[createTangents()](../../../api/library/rendering/class.mesh_cpp.md#createTangents_int_int)* and *[createNormals()](../../../api/library/rendering/class.mesh_cpp.md#createNormals_int_int)* functions.
...
- Add the box surface from the second mesh (*mesh_1*) to the first mesh (*mesh_0*) by using the *[addMeshSurface()](../../../api/library/rendering/class.mesh_cpp.md#addMeshSurface_cstr_ConstMesh_int_int_int)* function.
...
> **Notice:** You can copy a surface from the source mesh and add it to the existing surface of the current mesh without creating a new surface by using the overloaded *[addMeshSurface()](../../../api/library/rendering/class.mesh_cpp.md#addMeshSurface_cstr_ConstMesh_int_int_int)* function.
