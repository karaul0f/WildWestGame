...
- *[VrpnAnalogDevice](../../../api/library/plugins/vrpn/vrpnanalogdevice.class_usc.md)* class
- *[VrpnButtonDevice](../../../api/library/plugins/vrpn/vrpnbuttondevice.class_usc.md)* class
- *[VrpnTackerDevice](../../../api/library/plugins/vrpn/vrpntrackerdevice.class_usc.md)* class
...
- *[VrpnAnalogDevice](../../../api/library/plugins/vrpn/vrpnanalogdevice.class_usc.md)* that receives data about input devices sticks.
- *[VrpnButtonDevice](../../../api/library/plugins/vrpn/vrpnbuttondevice.class_usc.md)* that receives data about input devices buttons states.
- *[VrpnTrackerDevice](../../../api/library/plugins/vrpn/vrpntrackerdevice.class_usc.md)* that receives about position, orientation, velocity and acceleration of tracked objects from 3D tracking sensors.
