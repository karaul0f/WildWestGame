# Tracking Hands and Fingers With Ultraleap Plugin (CPP)
...
setTransform(camera_imodelview * camera_offset);

```


> **Notice:** Depending on your application, you might require to manually provide correct HMD Position that was updated during the plugin update **before the plugin swap event** using the [BeginSwap](../../../api/library/engine/class.engine_cpp.md#getEventBeginSwap_Event) event (native VR plugins already do this internally).
...
Hands are represented by the *[Hand](../../../api/library/plugins/ultraleap/class.ultraleaphand_cpp.md)* class.
...
Arms are represented by the *[Arm](../../../api/library/plugins/ultraleap/class.ultraleaparm_cpp.md)* class.
...
Fingers are represented by the *[Finger](../../../api/library/plugins/ultraleap/class.ultraleapfinger_cpp.md)* class.
...
Bones are represented by the *[Bone](../../../api/library/plugins/ultraleap/class.ultraleapbone_cpp.md)* class.
...
- The *[Ultraleap](../../../api/library/plugins/ultraleap/class.ultraleap_cpp.md)* interface article for more details on managing Ultraleap via API
- The *[Ultraleap](../../../api/library/plugins/ultraleap/class.ultraleapdevice_cpp.md)* interface article for more details on managing Ultraleap devices via API
- The *[Ultraleap Arm](../../../api/library/plugins/ultraleap/class.ultraleaparm_cpp.md)* class article for more details on managing arms via API
- The *[Ultraleap Bone](../../../api/library/plugins/ultraleap/class.ultraleapbone_cpp.md)* class article for more details on managing finger bones via API
- The *[Ultraleap Finger](../../../api/library/plugins/ultraleap/class.ultraleapfinger_cpp.md)* class article for more details on managing fingers via API
- The *[Ultraleap Hand](../../../api/library/plugins/ultraleap/class.ultraleaphand_cpp.md)* class article for more details on managing hands via API
...
If you run the application via UNIGINE SDK Browser, specify the command-line options given above in the *[Customize Run Options](../../../sdk/projects/index_cpp.md#customize_run)* form.
