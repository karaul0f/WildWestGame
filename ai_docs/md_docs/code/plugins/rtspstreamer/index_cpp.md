...
The ***[target_fps](../../../api/library/plugins/rtspstreamer/class.rtspstreamer_cpp.md#StreamDescription)*** value only defines the intended stream frame rate and is used by the encoder configuration and timing logic.
...
| Preset | H.264 [encoder preset](../../../api/library/plugins/rtspstreamer/class.rtspstreamer_cpp.md#EncoderPreset). |
| Profile | [H.264 profile](../../../api/library/plugins/rtspstreamer/class.rtspstreamer_cpp.md#H264Profile). |
| Level | [H.264 level](../../../api/library/plugins/rtspstreamer/class.rtspstreamer_cpp.md#H264Level). Available values: Auto, [3.0, 6.2]. |
...
The overlay can be controlled per stream through the [API](../../../api/library/plugins/rtspstreamer/class.rtspstreamer_cpp.md#setShowDebugInfo_StreamHandle_bool_void):
